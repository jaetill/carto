// Structured JSON logger for carto Lambdas per platform ADR-0009 section 1.
...
// PII field names that always get redacted. Carto-specific fields alongside
// platform-common ones.
const PII_FIELDS = [
  'email',
  'displayName',
  'name',
