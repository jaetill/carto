...
export async function feedbackHandler(event, context) {
...
// Standalone entrypoint — Sentry-wrapped for direct Lambda invocation
export const handler = Sentry.wrapHandler(feedbackHandler);
