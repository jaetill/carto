...
const STORAGE = {
  pkceVerifier: 'ct.pkce.verifier',
  state:        'ct.oauth.state',
  idToken:      'ct.id.token',
  accessToken:  'ct.access.token',
  refreshToken: 'ct.refresh.token',
  expiresAt:    'ct.expires.at',
};
...
function authBase() { return `https://${COGNITO.domain}`; }
...
export function getIdToken() { return localStorage.getItem(STORAGE.idToken); }
export function getAccessToken() { return localStorage.getItem(STORAGE.accessToken); }
